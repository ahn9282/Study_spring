package spring.study.proxy.config.v2_dynamicproxy;

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import spring.study.proxy.app.v1.*;
import spring.study.proxy.config.v2_dynamicproxy.handler.LogTraceBasicHandler;
import spring.study.proxy.config.v2_dynamicproxy.handler.LogTraceFilterHandler;
